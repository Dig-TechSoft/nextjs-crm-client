            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="text-center md:text-left space-y-4 flex-1">
                <div>
                  ...
                  <p className="text-xl text-muted-foreground mt-2">Trader Account</p>
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your registration and identity information</CardDescription>
              </CardHeader>
              <CardContent className="space-y-5">
                ...
                <Separator />
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Account ID (Login)</span>
          ...
          <Card className="border-dashed bg-muted/20">
            <CardContent className="py-8 text-center">
              <p className="text-lg font-medium text-foreground">
                Welcome back, <span className="text-primary font-bold">{profile.Name.split(" ")[0]}</span>!
              </p>
              <p className="text-sm text-muted-foreground mt-2">
                You're all set to trade with confidence on MT5 CRM.
              </p>
            </CardContent>
          </Card>
        </div>
